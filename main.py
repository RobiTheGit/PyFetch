...
print(colors.red, 'Model:', '\t',colors.white, (open('/sys/devices/virtual/dmi/id/product_name','r').readline()).replace('\n',''),colors.white)
print(colors.red, 'Vendor:', '\t',colors.white, (open('/sys/devices/virtual/dmi/id/sys_vendor','r').readline()).replace('\n',''),colors.white)
